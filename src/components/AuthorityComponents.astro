      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div 
            ...
            animate={{ x: 0 }} 
            exit={{ x: '100%' }} 
            className="fixed inset-0 bg-[#052c17] z-[120] p-8 flex flex-col justify-between text-white font-sans"
          >
  ...
  <section className="relative min-h-[90vh] lg:min-h-screen flex flex-col justify-end px-4 lg:px-20 pb-12 lg:pb-20 overflow-hidden bg-white pt-32 lg:pt-0">
    <div className="absolute top-0 right-0 w-full lg:w-3/5 h-[40vh] lg:h-full -z-10">
      <img 
        ...
        alt="Lahan pertanian sayur Cipanas" 
    ...
    <div className="max-w-[1600px] mx-auto w-full relative z-10 text-center lg:text-left">
      <motion.div 
        ...
        className="mb-6 lg:mb-10 inline-flex items-center gap-3 px-4 py-2 bg-[#052c17] text-white rounded-full"
      >
      ...
      <motion.h2 
        ...
        className="text-[14vw] lg:text-[10rem] font-serif leading-[0.85] tracking-[-0.05em] mb-8 lg:mb-12 text-[#052c17]"
      >
      ...
      <div className="lg:col-span-6 space-y-6 max-w-xl mx-auto lg:mx-0">
        ...
        <p className="text-base lg:text-xl font-medium text-slate-700 leading-relaxed italic border-l-4 border-[#15803d] pl-6 lg:pl-10">Kami mengelola distribusi langsung dari kebun Cipanas dengan armada pengiriman harian. Menjamin harga kompetitif dan kesegaran standar retail modern.</p>
